...
| Resource | URL |
|---|---|
| **UI (Web App)** | [https://fabric-iq-emp-knowledge-ui.azurewebsites.net](https://fabric-iq-emp-knowledge-ui.azurewebsites.net) |
| **API Base URL** | [https://fabric-iq-emp-knowledge-api.azurewebsites.net](https://fabric-iq-emp-knowledge-api.azurewebsites.net) |
| **Swagger UI** | [https://fabric-iq-emp-knowledge-api.azurewebsites.net/docs](https://fabric-iq-emp-knowledge-api.azurewebsites.net/docs) |
| **OpenAPI Spec** | [https://fabric-iq-emp-knowledge-api.azurewebsites.net/swagger.json](https://fabric-iq-emp-knowledge-api.azurewebsites.net/swagger.json) |
| **API Health Check** | [https://fabric-iq-emp-knowledge-api.azurewebsites.net/health](https://fabric-iq-emp-knowledge-api.azurewebsites.net/health) |
| **APIM Gateway** | [https://ai-gateway-apim-poc-my.azure-api.net](https://ai-gateway-apim-poc-my.azure-api.net) |
...
- **Endpoint**: [https://graph.microsoft.com/v1.0](https://graph.microsoft.com/v1.0) — configured in `config/service-config.json` → `microsoftGraph`
